  ...
  describe "GET 'index'" do
    ...
    describe "for non-signed-in users" do
      it "should deny access" do
        ...
        flash[:notice].should =~ /войдите на сайт/i
      end
    end
    ...
    describe "for signed-in users" do
      ...
      it "should have the right title" do
        get :index
        response.should have_selector("title", :content => "Все пользователи")
      end
      ...
      it "should paginate users" do
        ...
        response.should have_selector("span.disabled", :content => "Предыдущие")
